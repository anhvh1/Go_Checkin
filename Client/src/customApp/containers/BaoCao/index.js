...
import {message, Row, Col, Form, Select, Button} from "antd";
  ...
  render() {
    ...
    return (
      <LayoutWrapper>
        ...
        <PageAction>
          {/*<Link to={'checkin-out'}>*/}
          {/*  <Button type={'primary'} style={{height: 30}} onClick={()=>this.props.changeCurrent(['checkin-out'])}>Checkin-Out</Button>*/}
          {/*</Link>*/}
        </PageAction>
        ...
        <Box style={{display: showBaoCao ? '' : 'none', marginTop: 0, paddingTop: 5, border: '1px solid #ccc', minWidth: 1400}}>
