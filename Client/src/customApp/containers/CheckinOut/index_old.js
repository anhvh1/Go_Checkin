...
class CheckinOut extends Component {
  ...
  render() {
    ...
    const cameraContent = (
      <img id="video" style={{maxHeight: 150}}
           src={IPCamera} alt=""/>
    );
                  ...
                  {loadingChanDung && imageChanDung === "" ?
                    <Icon type={'loading'}/> : imageChanDung !== "" && !showCamera ?
                      <img src={imageChanDung} alt="avatar"
                           style={{maxHeight: 150}}/> : showCamera ? cameraContent : uploadChanDung}
                </div>
              </Dragger>
              <div className={'button-scan'}>
                ...
                <Button icon={'camera'} disabled={loadingTruoc || loadingSau || loadingChanDung || isCheckIn}
