...
{
    [Route("api/v4/DanhMucCoQuanDonVi")]
    [ApiController]
    public class DanhMucCoQuanDonViV4Controller : BaseApiController
    {
        private IDanhMucCoQuanDonViV4BUS _DanhMucCoQuanDonViBUS;
        private IHostingEnvironment _host;
        private ISystemConfigBUS _systemConfigBUS;
        public IOptions<AppSettings> settings;
        public DanhMucCoQuanDonViV4Controller(IOptions<AppSettings> Settings, ISystemConfigBUS systemConfigBUS, IDanhMucCoQuanDonViV4BUS DanhMucCoQuanDonViBUS, IHostingEnvironment hostingEnvironment, ILogHelper _LogHelper, ILogger<DanhMucCoQuanDonViV4Controller> logger) : base(_LogHelper, logger)
        {
        ...
        [HttpGet]
        [CustomAuthAttribute(ChucNangEnum.HT_DanhMucCoQuan, AccessLevel.Read)]
