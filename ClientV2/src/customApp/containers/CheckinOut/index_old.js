...
class CheckinOut extends Component {
  ...
  render() {
    ...
    const cameraContent = (
      <img id="video" style={{ maxHeight: 150 }} src={IPCamera} alt="" />
    );
            ...
            <div className={"upload-div"}>
              ...
              <div className={"button-scan"}>
                ...
                <Button
                  // icon={"camera"}
                  disabled={
                    loadingTruoc || loadingSau || loadingChanDung || isCheckIn
                  }
