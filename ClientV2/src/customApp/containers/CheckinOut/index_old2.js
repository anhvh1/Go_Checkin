          ...
          {roleBaoCao.view ? (
            <Link to="bao-cao">
              <Button
                type={"primary"}
                style={{ height: 30 }}
                onClick={() => this.props.changeCurrent(["bao-cao"])}
              >
                Xem danh sách
              </Button>
            </Link>
          ...
          <div className={"upload-container"}>
            ...
            <div className={"upload-div"}>
              ...
              <div className={"button-scan"}>
                <Button
                  style={{ backgroundColor: "#ccc", color: "black" }}
                  // icon={showCamera ? "picture" : "upload"}
              ...
              <Col {...COL_ITEM_LAYOUT_HALF}>
                ...
                >
                  ...
                  <Input
                    ...
                    style={{ width: "30%", maxWidth: 100 }}
                    value={
                      isCheckOut ? moment(today).format("HH:mm") : valueGioRaHS
                    }
                    disabled
                    suffix={<ClockCircleOutlined />}
                  />
                  ...
                  <Col {...COL_COL_ITEM_LAYOUT_RIGHT}>
                    <Item label={"Nơi cấp"} {...ITEM_LAYOUT_HALF}>
                      <Input
                        ...
                        onChange={(value) =>
                          this.changeValueCMT("NoiCapCMND", value.target.value)
                        }
                      />
                    </Item>
                  </Col>
            ...
            <Row>
              <Col {...COL_ITEM_LAYOUT_HALF}>
                <Item label={"Ngày sinh"} {...ITEM_LAYOUT_HALF}>
                  ...
                  <DatePicker
                    onChange={(value) => this.changeValueCMT("NgaySinh", value)}
                    format={"DD/MM/YYYY"}
                    style={{ width: "100%" }}
                    placeholder={""}
