...
import actions from "../../redux/TruyVetToanTinh/actions";
...
class TruyVetToanTinh extends Component {
  constructor(props) {
    super(props);
    document.title = "Truy vết toàn hệ thống";
  ...
  render() {
    ...
    return (
      <LayoutWrapper>
        <PageHeader>Truy vết toàn hệ thống</PageHeader>
        <Box>
          <BoxFilter>
            Từ
...
function mapStateToProps(state) {
  return {
    ...state.TruyVetToanTinh,
    role: getRoleByKey(state.Auth.role, 'truy-vet-toan-tinh')
  };
}
