...
{
    public interface IDanhMucCoQuanDonViV4BUS
    {
    ...
    public class DanhMucCoQuanDonViV4BUS : IDanhMucCoQuanDonViV4BUS
    {

        private IDanhMucCoQuanDonViV4DAL _DanhMucCoQuanDonViDAL;
        public DanhMucCoQuanDonViV4BUS(IDanhMucCoQuanDonViV4DAL coQuanDonViDAL)
        {
