...
namespace Com.Gosol.INOUT.DAL.EFCore
{
    public partial class DbINOUTContext : DbContext
    {
        public DbINOUTContext()
        {
        }

        public DbINOUTContext(DbContextOptions<DbINOUTContext> options)
            : base(options)
        {
        }
